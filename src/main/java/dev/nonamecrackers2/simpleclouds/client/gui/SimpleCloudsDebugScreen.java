...
public class SimpleCloudsDebugScreen extends Screen
{
	...
	protected void init()
	{
		...
		if (this.minecraft.level != null && SimpleCloudsRenderer.getInstance().getMeshGenerator() instanceof MultiRegionCloudMeshGenerator generator)
		{
			...
			CLOUD_REGION_TEST.init(types, generator.getCloudRegionTextureGenerator().getTextureSize(), 8.0F, manager.getScrollX(), manager.getScrollZ(), cameraPos.x, cameraPos.z, SimpleCloudsConstants.CLOUD_SCALE);
		}
	}
