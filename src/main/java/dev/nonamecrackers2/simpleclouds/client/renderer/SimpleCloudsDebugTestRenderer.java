...
public class SimpleCloudsDebugTestRenderer
{
	public static final SimpleCloudsDebugTestRenderer INSTANCE = new SimpleCloudsDebugTestRenderer();
	private final int vertexBufferId;
	private final int indexBufferId;
	private final int arrayObjectId;
	
	public SimpleCloudsDebugTestRenderer()
	{
...
//		try {
//			this.computeShader = ComputeShader.loadShader(SimpleCloudsMod.id("test"), Minecraft.getInstance().getResourceManager());
//			int id = GL15.glGenBuffers();
//			float[] data = new float[] {1.0F, 2.0F, 3.0F, 4.0F};
//			GL15.glBindBuffer(GL43.GL_SHADER_STORAGE_BUFFER, id);
//			GL15.glBufferData(GL43.GL_SHADER_STORAGE_BUFFER, data, GL45.GL_STREAM_DRAW);
//			GL45.glBindBufferBase(GL43.GL_SHADER_STORAGE_BUFFER, 0, id);
//			GL15.glBindBuffer(GL43.GL_SHADER_STORAGE_BUFFER, 0);
//			
//			this.computeShader.apply();
//			GL43.glDispatchCompute(2, 1, 1);
//			this.computeShader.clear();
//			GL42.glMemoryBarrier(GL45.GL_ALL_BARRIER_BITS);
////			
//			GL15.glBindBuffer(GL43.GL_SHADER_STORAGE_BUFFER, id);
//			ByteBuffer buffer = GL15.glMapBuffer(GL43.GL_SHADER_STORAGE_BUFFER, GL45.GL_WRITE_ONLY);
//			while (buffer.position() < buffer.capacity())
//				System.out.println(buffer.getFloat());
////			data = buffer.asFloatBuffer().array();
//			GL15.glUnmapBuffer(GL43.GL_SHADER_STORAGE_BUFFER);
////			GL15.glGetBufferSubData(GL45.GL_SHADER_STORAGE_BUFFER, 0, data);
////			for (int i = 0; i < data.length; i++)
////				System.out.println(data[i]);
//			
//			this.computeShader.close();
//		}
//		catch (IOException e)
//		{
//			e.printStackTrace();
